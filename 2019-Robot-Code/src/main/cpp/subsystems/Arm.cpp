...
const double BASE_SENSOR_VALUES[LEVEL_COUNT] = { 2.976, 2.933, /*3.42*/3.375, 3.817, 4.310, 2.974, 3.441, 3.947 };
const double WRIST_SENSOR_VALUES[LEVEL_COUNT] = { 3.9, 3.508, 3.443, 3.473, 3.309, 3.872, 3.4787, 3.680 };
    ...
    Subsystem("ARM")
{
    ...
    m_wristPID.SetOutputRange(-0.3, 0.7);
